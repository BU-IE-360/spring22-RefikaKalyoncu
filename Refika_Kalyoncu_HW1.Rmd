...
Even though the correlation between "home for sale search" and interest rate for housing is only 0.14 one can observe the positive relation from the above plot. Only the values from 20 to 25 seem to break the layout of a linear line. 
