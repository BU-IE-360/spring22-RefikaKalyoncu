...
```
  ...
  In the second graph we can clearly see the relation between exchange rate and price index. This relation is much more consistent. Mosly the correlation is above 0.5 only in 2014 the correlation is negative. 
  In the third plot we see an inconsistent and continuosly changeable correlation one it's positive one time it's negative. This may be due to the fact that interest rates are determined by central bank and the decisions are not applied instatntly so it cannot act directly according to inflation rate.


# Google Trend 

I searched for "Satılık daire" in Google trend to see what is the relation between searching for houses and price indexes. Before examining the data I thought that as house prices increased, people would search less for homes for sale.However the correlation between price index and the google trend data shows exactly the opposite. The correlation value is 0.86. Which shows the data is highly correlated in a positive manner. So,it seems that as the price increases people tend to search more for apartments for sale. This could be as a result of not being able to find an affordable house, people search for a house for much longer time.Therefore the amount of searching for the "Satılık daire" may be increasing. 
...
-The searches about "home for sale" is positively correlated with the housing price index as well as exchange rate. TThis may be due to the fact that the process of finding a house is getting longer as the price increases and the purchasing power decreases.
...
# Appendices
 ...
 - *1.* [Rmd file](https://github.com/BU-IE-360/spring22-RefikaKalyoncu/blob/gh-pages/Refika_Kalyoncu_HW1.Rmd) for the report.